...
public class Villager {
  ...
  Image average_back =
      Toolkit.getDefaultToolkit()
          .getImage("entities/villager average/average village guy back.png");
  Image average_front =
      Toolkit.getDefaultToolkit()
          .getImage("entities/villager average/average village guy front.png");
  Image average_right =
      Toolkit.getDefaultToolkit()
          .getImage("entities/villager average/average village guy right.png");
  Image average_left =
      Toolkit.getDefaultToolkit()
          .getImage("entities/villager average/average village guy left.png");

  Image elder_back =
      Toolkit.getDefaultToolkit().getImage("entities/villager elder/elder village guy back.png");
  Image elder_front =
      Toolkit.getDefaultToolkit().getImage("entities/villager elder/elder village guy front.png");
  Image elder_right =
      Toolkit.getDefaultToolkit().getImage("entities/villager elder/elder village guy right.png");
  Image elder_left =
      Toolkit.getDefaultToolkit().getImage("entities/villager elder/elder village guy left.png");
  ...
  public void eldervillagerdiscuss() {
    ...
    if (thing != null) {
      if (thing
        ...
        String wizardanswer =
            MainLoop.ChooseAnswer(
                thingsyoucouldsay,
                "village elder: Nice speech. I like it. But we don't need a storyteller. We need a hero");
        if (wizardanswer != null) {
          ...
          String answers =
              MainLoop.ChooseAnswer(
                  thingsyoucouldsay2,
                  "village elder: So you saw those spiders on the way here, right?");
          if (answers == "No.") {
            ...
            MainLoop.Say(
                "My people are not warriors by nature. Our villagers at arms were the first to be eaten.");
