...
public class UsefulMethods {
  ...
  public static Image plainsgrass =
      Toolkit.getDefaultToolkit().getImage("maptiles/plains grass.png");
  ...
  public static Image ordinaryforest =
      Toolkit.getDefaultToolkit().getImage("maptiles/forest grass.png");
  public static Image junglegrass =
      Toolkit.getDefaultToolkit().getImage("maptiles/jungle grass.png");
  public static Image northcliff = Toolkit.getDefaultToolkit().getImage("maptiles/northcliff.png");
  public static Image northeastcliff =
      Toolkit.getDefaultToolkit().getImage("maptiles/northeastcliff.png");
  public static Image eastcliff = Toolkit.getDefaultToolkit().getImage("maptiles/eastcliff.png");
  public static Image southeastcliff =
      Toolkit.getDefaultToolkit().getImage("maptiles/southeastcliff.png");
  public static Image southcliff = Toolkit.getDefaultToolkit().getImage("maptiles/southcliff.png");
  public static Image southwestcliff =
      Toolkit.getDefaultToolkit().getImage("maptiles/southwestcliff.png");
  public static Image westcliff = Toolkit.getDefaultToolkit().getImage("maptiles/westcliff.png");
  public static Image northwestcliff =
      Toolkit.getDefaultToolkit().getImage("maptiles/northwestcliff.png");
  public static Image corruption = Toolkit.getDefaultToolkit().getImage("maptiles/corruption.png");
  public static Image SmallHorizontalWoodVillageHouseChunk1 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk1.png");
  public static Image SmallHorizontalWoodVillageHouseChunk2 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk2.png");
  public static Image SmallHorizontalWoodVillageHouseChunk3 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk3.png");
  public static Image SmallHorizontalWoodVillageHouseChunk4 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk4.png");
  public static Image SmallHorizontalWoodVillageHouseChunk5 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk5.png");
  public static Image SmallHorizontalWoodVillageHouseChunk6 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk6.png");
  public static Image SmallHorizontalWoodVillageHouseChunk7 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk7.png");
  public static Image SmallHorizontalWoodVillageHouseChunk8 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk8.png");
  public static Image SmallHorizontalWoodVillageHouseChunk9 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk9.png");
  public static Image SmallHorizontalWoodVillageHouseChunk10 =
      Toolkit.getDefaultToolkit().getImage("maptiles/SmallHorizontalWoodVillageHouseChunk10.png");
  public static Image woodwall =
      Toolkit.getDefaultToolkit().getImage("maptiles/housetiles/wood wall.png");
  public static Image woodfloor =
      Toolkit.getDefaultToolkit().getImage("maptiles/housetiles/wood planks.png");
  public static Image woodtop =
      Toolkit.getDefaultToolkit().getImage("maptiles/housetiles/top of wall.png");
  public static Image stonewall =
      Toolkit.getDefaultToolkit().getImage("maptiles/villagecentertiles/stonebrick.png");
  public static Image stonewallshadow =
      Toolkit.getDefaultToolkit().getImage("maptiles/villagecentertiles/stoneroofthing.png");
  public static Image villagecenterdoor =
      Toolkit.getDefaultToolkit().getImage("maptiles/villagecentertiles/stonedoor.png");
  public static Image redroof =
      Toolkit.getDefaultToolkit().getImage("maptiles/villagecentertiles/redshingleroofthing.png");
    ...
    for (int i = 0; i < 14; i++) {
      for (int a = 0; a < 14; a++) {
        try {
          ...
          else if (thing == northcliff
              || thing == northeastcliff
              || thing == eastcliff
              || thing == southeastcliff
              || thing == southcliff
              || thing == southwestcliff
              || thing == westcliff
              || thing == northwestcliff) {
            switchthis = 1;
          } else if (thing == SmallHorizontalWoodVillageHouseChunk1
              || thing == SmallHorizontalWoodVillageHouseChunk2
              || thing == SmallHorizontalWoodVillageHouseChunk3
              || thing == SmallHorizontalWoodVillageHouseChunk4) {
            switchthis = 1;
          } else if (thing == SmallHorizontalWoodVillageHouseChunk5
              || thing == SmallHorizontalWoodVillageHouseChunk6
              || thing == SmallHorizontalWoodVillageHouseChunk7) {
            switchthis = 1;
          } else if (thing == SmallHorizontalWoodVillageHouseChunk9
              || thing == SmallHorizontalWoodVillageHouseChunk10) {
            switchthis = 1;
  ...
  private static void writeEntities(BufferedWriter bw, Dungeon activeDungeon) throws IOException {
    for (int i = 0;
        i < activeDungeon.Entitys.size();
        i++) // iterating through the entities in a dungeon
    {
      bw.newLine();
  ...
  public static void SaveGame() {
    try {
      ...
      if (MainLoop.ChooseAnswer(
              new String[] {"Yes", "No, not really"},
              "Do you want to listen to me blabber about what I think caused it?")
          == "Yes") {
        MainLoop.Say(
            "Perhaps you are using a linux or mac copmuter. This game can only work on windows. Why? Becaouse windows is BETTER.");
