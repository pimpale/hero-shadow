...
public class Item {
  ...
  static Image BronzeShortSword =
      Toolkit.getDefaultToolkit().getImage("Items/bronze short sword.png");
  ...
  private static Object[] GetWeaponStatsNull() {
    ...
    double speed = 0;
    Object[] returnthis =
        new Object[] {attack, defense, effects, projectilelife, weapontype, cooldown, speed};
    return returnthis;
  }
